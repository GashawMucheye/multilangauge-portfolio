...
// import { LanguageReviewOutput } from '@/src/ai/flows/language-review';
...
interface LanguageContent {
  ...
  dialogTitle?: Record<string, string>;
  dialogDescription?: Record<string, string>;
  languageLabel?: Record<string, string>;
  contentLabel?: Record<string, string>;
  contentPlaceholder?: Record<string, string>;
  loading?: Record<string, string>;
  reviewedContentTitle?: Record<string, string>;
  feedbackTitle?: Record<string, string>;
}
...
export function LanguageReview({ languageContent }: LanguageReviewProps) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      if (!res.ok) throw new Error('Request failed');
      const data: LanguageReviewOutput = await res.json();
      setReviewResult(data);
    } catch (error) {
      console.error('Language review request failed:', error);
    } finally {
